 ...
 * NaN
 * В случае, если аргументы командной строки переданы, программа преобразует
 * их в массив intArray и d соответственно. Затем вызывается метод expr,
 * и результат выводится на экран, например:
 * intArray[8] / d = 8 / 3 = 2.6666666666666665
 * 2.6666666666666665
 * Программа должна выдавать следующие ошибки:
 * Если длина массива меньше 9:
 * It's not possible to evaluate the expression - intArray[8] / d as there is
 ...
 * Входные аргументы:
 * 1 2 3 It's not possible to evaluate the expression - intArray[8] / d as there is no 8th element in the given array.
...
class Expr {
    ...
    public static double expr(int[] intArray, int d) {
        ...
        try {
            y = intArray[8] / d;
            try {
                y = (double) intArray[8] / d;
                System.out.printf("intArray[8] / d = %d / %d = %s\n", intArray[8], d, y);
